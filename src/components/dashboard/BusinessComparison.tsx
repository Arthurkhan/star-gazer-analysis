...
import { Star, TrendingUp, Users, Calendar, AlertCircle, ThumbsUp, Info } from "lucide-react";
      ...
      <div className="space-y-6">
                ...
                {growthComparison.find(g => g.name === business.name)?.growthRate !== 0 && (
                  <div className="mt-2 flex items-center gap-1 text-sm">
                    ...
                    <UITooltip>
                      ...
                      <TooltipContent>
                        <p>Month-over-month growth comparing<br />last month vs. previous month</p>
                      </TooltipContent>
                    </UITooltip>
                  </div>
                )}
          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <UITooltip>
                ...
                <TooltipContent>
                  <p>Shows the number of reviews received each month.<br />
                  Helps identify seasonal patterns and growth trends.</p>
                </TooltipContent>
              </UITooltip>
            </CardTitle>
          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <UITooltip>
                ...
                <TooltipContent>
                  <p>Total accumulated reviews over time.<br />
                  Shows overall growth trajectory and momentum.</p>
                </TooltipContent>
              </UITooltip>
            </CardTitle>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                <UITooltip>
                  ...
                  <TooltipContent>
                    <p>AI-analyzed emotional tone of reviews.<br />
                    Positive: Happy, satisfied reviews<br />
                    Neutral: Balanced, factual reviews<br />
                    Negative: Complaints or dissatisfaction</p>
                  </TooltipContent>
                </UITooltip>
              </CardTitle>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                Market Share by Review Count
                <UITooltip>
                  <TooltipTrigger>
                    <Info className="h-4 w-4 text-muted-foreground" />
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>Percentage of total reviews each business receives.<br />
                    Indicates relative market presence and customer engagement.</p>
                  </TooltipContent>
                </UITooltip>
              </CardTitle>
          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <UITooltip>
                ...
                <TooltipContent>
                  <p>Calculates the percentage change in reviews<br />
                  Formula: ((This Month - Last Month) / Last Month) × 100<br />
                  Positive % = Growth, Negative % = Decline</p>
                </TooltipContent>
              </UITooltip>
            </CardTitle>
          ...
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <UITooltip>
                ...
                <TooltipContent>
                  <p>Breakdown of star ratings (1-5 stars).<br />
                  Shows customer satisfaction distribution.<br />
                  Higher percentages in 4-5 stars indicate better performance.</p>
                </TooltipContent>
              </UITooltip>
            </CardTitle>
