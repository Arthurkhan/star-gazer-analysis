...
import {
  ...
  Bar as _Bar,
  LineChart as _RechartsLineChart,
  Line as _Line,
  XAxis as _XAxis,
  YAxis as _YAxis,
...
const _CustomPieTooltip = ({ active, payload }: CustomPieTooltipProps) => {
  if (active && payload && payload.length) {
    return (
      <div className='bg-white dark:bg-gray-800 p-3 border rounded shadow-lg'>
...
export function EnhancedAnalysisDisplay({
  ...
  historicalTrends: _historicalTrends,
  reviewClusters: _reviewClusters,
