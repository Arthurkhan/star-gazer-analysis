...
export const calculateBusinessHealthScore = (
  ...
  const sentimentScore = currentPeriod.metrics.sentimentScore;
...
export const calculateRatingAnalysis = (
...
export const calculateResponseAnalytics = (reviews: Review[]): ResponseAnalytics => {
  const totalReviews = reviews.length;
...
export const calculateSentimentAnalysis = (reviews: Review[]): SentimentAnalysis => {
...
// Calculate thematic analysis
export const calculateThematicAnalysis = (reviews: Review[]): ThematicAnalysis => {
...
// Main function to generate complete analysis summary
