          ...
          <div className='space-y-4'>
            ...
            {mentions.length > 0 ? (
              ...
              <div className='text-center py-8 text-muted-foreground'>
                ...
                <p className='text-sm'>
                  Staff mentions will appear as customers name team members
                </p>
              </div>
            )}
          </div>
              ...
              <div className='space-y-2'>
                ...
                <div className='space-y-1'>
                  {trainingOpportunities.map((opportunity, index) => (
                    <div
                      key={index}
                      className='text-sm p-2 bg-yellow-50 rounded border-l-2 border-yellow-400'
                    >
                      {opportunity}
                    </div>
                  ))}
              ...
              <div className='space-y-2 text-sm'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium'>
                    {mentions.reduce(
                      (sum, staff) => sum + staff.totalMentions,
                      0,
                    )}
                  </span>
                </div>
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium text-green-600'>
                    {mentions.length > 0
                      ? Math.round(
                          (mentions.reduce(
                            (sum, staff) => sum + staff.positiveMentions,
                            0,
                          ) /
                            mentions.reduce(
                              (sum, staff) => sum + staff.totalMentions,
