...
export function SetupApiKeyDialog() {
  ...
  const [anthropicModel, setAnthropicModel] = useState(
    localStorage.getItem('ANTHROPIC_MODEL') || 'claude-3-haiku-20240307',
  )
  const [geminiModel, setGeminiModel] = useState(
    localStorage.getItem('GEMINI_MODEL') || 'gemini-1.5-pro',
  )
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className='sm:max-w-md'>
        <DialogHeader>
          ...
          <DialogDescription>
            Select your preferred AI provider and enter your API key to enable
        ...
        >
          ...
          <TabsContent value='openai' className='space-y-4'>
            ...
            <div className='grid grid-cols-4 items-start gap-4'>
              <Label className='text-right pt-2'>Model</Label>
                    ...
                    <div className='border p-4 rounded-md'>
                      ...
                      <div className='space-y-2'>
                        <div className='flex items-center space-x-2'>
                          ...
                          <Label htmlFor='gpt-4o' className='font-normal'>
                            GPT-4o
                          </Label>
                        </div>
                        <div className='flex items-center space-x-2'>
                          <RadioGroupItem
                            ...
                            id='gpt-4o-mini'
                          />
                          <Label htmlFor='gpt-4o-mini' className='font-normal'>
                            GPT-4o Mini
                          </Label>
                        </div>
                      </div>
                    ...
                    <div className='border p-4 rounded-md'>
                      ...
                      <div className='space-y-2'>
                        <div className='flex items-center space-x-2'>
                          ...
                          <Label htmlFor='gpt-4.1' className='font-normal'>
                            GPT-4.1
                          </Label>
                        </div>
                        <div className='flex items-center space-x-2'>
                          <RadioGroupItem
                            ...
                            id='gpt-4.1-mini'
                          />
                          <Label htmlFor='gpt-4.1-mini' className='font-normal'>
                            GPT-4.1 Mini
                          </Label>
                        </div>
                        <div className='flex items-center space-x-2'>
                          <RadioGroupItem
                            ...
                            id='gpt-4.1-nano'
                          />
                          <Label htmlFor='gpt-4.1-nano' className='font-normal'>
                            GPT-4.1 Nano
                          </Label>
                        </div>
                      </div>
