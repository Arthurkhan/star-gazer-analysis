  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Monthly Report Summary</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              {summaryData.comparison.previousPeriod.change > 0 ? '+' : ''}
              {summaryData.comparison.previousPeriod.change} from previous period
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{enhancedMetrics.satisfactionRate}%</div>
            <p className="text-xs text-muted-foreground">
              4+ star reviews
            </p>
          </CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <HealthIcon className={`h-4 w-4 ${getHealthScoreColor(enhancedMetrics.healthScore)}`} />
          </CardHeader>
          <CardContent>
            <div className={`text-2xl font-bold ${getHealthScoreColor(enhancedMetrics.healthScore)}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {summaryData.comparison.previousPeriod.percentage.toFixed(1)}% change from {summaryData.comparison.previousPeriod.totalReviews} reviews
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                {summaryData.comparison.previousYear.percentage.toFixed(1)}% change from {summaryData.comparison.previousYear.totalReviews} reviews
              </p>
            </div>
          </div>
        </CardContent>
