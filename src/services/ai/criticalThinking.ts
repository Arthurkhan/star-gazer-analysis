...
import type { BusinessMetrics} from '@/types/businessTypes'
import { BusinessType, industryBenchmarks } from '@/types/businessTypes'
import type { PatternInsight, BusinessScenario, CompetitiveAnalysis, CompetitiveInsight } from '@/types/recommendations'
